    ...
    private static createTable = async () => {
        try {
            ...
            INSERT OR IGNORE INTO students (id, name, classId) VALUES
                ...
                ('s63', 'Larissa Ferreira (professora)', 4),
                ('s64', 'Lorenna', 4),
                ('s65', 'Larissa Silva', 4),
                ('s66', 'Marcelo (professor)', 4),
                ('s67', 'Mateus (professor)', 4),
                ('s68', 'Marieta', 4),
                ('s69', 'Milena (professora)', 4),
                ('s70', 'Lucas', 4),
                ('s71', 'Carlos Alan', 4),
                ('s72', 'Everton', 4),
                ('s73', 'Cleverton (professor)', 4),
                ('s74', 'Alaís', 4),
                ('s75', 'Tiago', 4),
                ('s76', 'Joice', 4),
                ('s77', 'Tainan (professora)', 4),
                ('s78', 'Taiz', 4),
                ('s79', 'Sayonara', 4),
                ('s80', 'Thierry', 4),
                ('s81', 'Tarcisio', 4),
                ('s82', 'Benfamim (França)', 1),
                ('s83', 'Saimon', 1),
                ('s84', 'Manuela', 1),
                ('s85', 'Bernardo', 1),
                ('s86', 'Emamuel', 1),
                ...
                ('s108', 'Tiago', 3),
                ('s109', 'Raquel', 3),
                ('s110', 'Breno (professor)', 3),
                ('s111', 'Natã', 3),
                ('s112', 'Nicole', 3),
                ('s113', 'Maria Eduarda', 3),
                ('s114', 'Railan', 3);
